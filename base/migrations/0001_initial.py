# Generated by Django 4.2.1 on 2023-11-22 20:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='love_activity',
            field=models.ManyToManyField(blank=True, related_name='love_activity', to='base.activity'),
        ),
        migrations.AddField(
            model_name='user',
            name='love_comp',
            field=models.ManyToManyField(blank=True, related_name='love_comp', to='base.competition'),
        ),
        migrations.AddField(
            model_name='user',
            name='nope_activity',
            field=models.ManyToManyField(blank=True, related_name='nope_activity', to='base.activity'),
        ),
        migrations.AddField(
            model_name='user',
            name='nope_comp',
            field=models.ManyToManyField(blank=True, related_name='nope_comp', to='base.competition'),
        ),
        migrations.AddField(
            model_name='user',
            name='top3',
            field=models.ManyToManyField(blank=True, to='base.ourtag'),
        ),
        migrations.AddField(
            model_name='user',
